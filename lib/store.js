...
function load() {
  ...
  try { return read(DB_PATH); } catch { /* file chính hỏng/thiếu -> thử bản dự phòng */ }
  try {
...
function seedSmoke() {
  ...
  fs.writeFileSync(DB_PATH, JSON.stringify({ folders: [], lists: [{ id: 'inbox', name: 'Inbox', folderId: null }, { id: uid(), name: 'Học tập', folderId: null }], tasks: [p, c1, c2, d, e], settings: {} }, null, 1));
}

module.exports = { DB_PATH, DEFAULT, KEY_LABELS, load, get, set, save, flush, writeNow, seedSmoke };
