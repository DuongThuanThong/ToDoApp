...
/* Khung "Định kì": việc LẶP có khung riêng để quản lý/custom lịch, không lẫn với việc lỡ quên hạn. */
assert.deepStrictEqual(T.view([{ id: 'a', title: 'A', done: false, parentId: null, listId: 'inbox', due: null, repeat: null },
  { id: 'b', title: 'B', done: false, parentId: null, listId: 'inbox', due: null, repeat: { type: 'weekly', n: 1, days: [1, 4] } },
  { id: 'c', title: 'C', done: false, parentId: null, listId: 'inbox', due: null, repeat: { type: 'daily', n: 1 } },
  { id: 'd', title: 'D', done: true, parentId: null, listId: 'inbox', due: null, repeat: { type: 'daily', n: 1 } }], 'nodate', TODAY).map((x) => x.id), ['a'],
  'việc lặp KHÔNG được nằm trong "Chưa có hạn" nữa');
assert.deepStrictEqual(T.view([{ id: 'a', title: 'A', done: false, parentId: null, listId: 'inbox', due: null, repeat: null },
  { id: 'b', title: 'B', done: false, parentId: null, listId: 'inbox', due: null, repeat: { type: 'weekly', n: 1, days: [1, 4] } },
  { id: 'c', title: 'C', done: false, parentId: null, listId: 'inbox', due: null, repeat: { type: 'daily', n: 1 } },
  { id: 'd', title: 'D', done: true, parentId: null, listId: 'inbox', due: null, repeat: { type: 'daily', n: 1 } }], 'recur', TODAY).map((x) => x.id), ['b', 'c'],
  '"Định kì" phải gom mọi việc lặp CHƯA XONG (bản đang chạy), bỏ bản đã xong và việc một lần');
