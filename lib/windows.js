...
function createMini() {
  ...
  miniWin = new BrowserWindow({
    ...
    // hasShadow:false là BẮT BUỘC: cửa sổ trong suốt mà Windows vẫn vẽ bóng DWM quanh cả khung cửa sổ
    // -> lúc thu gọn thành thanh mép 10px, phần trống còn lại hiện ra như khung nút bự cũ (42x44)
    // mà không cách nào bỏ được vì Windows chặn cửa sổ nhỏ hơn ~41 DIP.
    webPreferences: { preload: PRE, contextIsolation: true, nodeIntegration: false, sandbox: false },
  });
