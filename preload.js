...
const { parseSmart, view, autoSchedule, stats, toggleDone, subtaskProgress, overdue, setDue, inheritDue } = require('./lib/tasks');
...
contextBridge.exposeInMainWorld('api', {
  ...
  T: { parseSmart, view, autoSchedule, stats, toggleDone, subtaskProgress, overdue, setDue, inheritDue },
});
